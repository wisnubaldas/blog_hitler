<!-- begin #header -->
<div id="header" class="header {{ $html_class->headerClass }}">
	<!-- begin navbar-header -->
	<div class="navbar-header">
	<a href="#" class="navbar-brand"><span class="navbar-logo"></span> <b>{{config('app.name')}}</b> {{config('app.company')}}</a>
		@if (!$html_class->sidebarHide)
	...
	@includeWhen($html_class->headerMegaMenu, 'back.includes.header-mega-menu')
	
	<!-- begin header-nav -->
	<ul class="navbar-nav navbar-right">
		<li class="{{ $html_class->hiddenSearch }} ">
		...
		@if($html_class->headerLanguageBar)
