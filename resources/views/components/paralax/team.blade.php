    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="team">             
                    <div class="image" data-animation="true" data-animation-type="flipInX">
                        <img src="{{asset('blog/img/user/user-1.jpg')}}" alt="Ryan Teller" />
                    </div>
                    <div class="info">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="team">             
                    <div class="image" data-animation="true" data-animation-type="flipInX">
                        <img src="{{asset('blog/img/user/user-2.jpg')}}" alt="Jonny Cash" />
                    </div>
                    <div class="info">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="team">             
                    <div class="image" data-animation="true" data-animation-type="flipInX">
                        <img src="{{asset('blog/img/user/user-3.jpg')}}" alt="Mia Donovan" />
                    </div>
                    <div class="info">
