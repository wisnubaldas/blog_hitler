...
<div id="contact" class="content bg-silver-lighter" data-scrollview="true">
    <!-- begin container -->
    <div class="container">
        <h2 class="content-title">Saran dan Kritik</h2>
        <p class="content-desc">
            Kami terbuka untuk memberikan masukan dan saran kepada kami,<br/>
            agar dapat memaksimalkan layanan kepada Masyarakat.
        </p>
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-6" data-animation="true" data-animation-type="fadeInLeft">
                <h3>Jika membutuhkan layanan lebih lanjut seputar program silahkan kunjungi kami.</h3>
                <p>
